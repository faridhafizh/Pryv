Microdata Privacy Guard Logo

# **Microdata Privacy Guard (MVP)**

**SaaS Anonymization Platform for Official Census Datasets (BPS)**

*Ensuring K-Anonymity & Dynamic PII Protection Prior to Public Release*

Next.js [FastAPI](https://fastapi.tiangolo.com/) [Supabase](https://supabase.com/) [Python](https://www.python.org/) License
...
\-- Executes migrations/0001\_init.sql
...
Distributed under the MIT License. See [LICENSE](http://LICENSE) for more information.  
